...
- `corepack yarn serve` — run Express + static platform
- `corepack yarn seed:admin` — seed admin user
- `corepack yarn build` — run `build.js`
- `corepack yarn check` — JavaScript syntax checks for build/server files

...
Canonical governance script: `assets/js/guardian.js`.  
Legacy typo file `assets/js/gaurdian.js` may exist for backward compatibility and should not receive new edits.
...
- Add new components by updating source files and, when needed, `requiredFiles` and `copyEntries` in `build-visiva.js`.
